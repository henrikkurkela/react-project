...
describe('Avatars', () => {
    it('contains the correct avatars', async () => {
        ...
        http.getRequest.mockResolvedValue({ status: 200, data: ['/assets/avatar/1.jpg', '/assets/avatar/2.jpg', '/assets/avatar/3.jpg', '/assets/avatar/anon.jpg', '/assets/avatar/default.jpg'] })
